  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const res = await axios.get(`${BASE_URL}/api/v1/getshirts?category=oversized`);
...
<div className="containers-getallshirts">
        <div className="main-box-getallshirts">
          <h2 className="title-getallshirts">Anime shirt collections</h2>
          <br></br>
...
export default oversizedshirts
